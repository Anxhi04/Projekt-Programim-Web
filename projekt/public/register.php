...
<head>
    ...
    <link rel="stylesheet" href="/projekt/includes/css/bootstrap.min.css">
    <!--    <link rel="stylesheet" href="/projekt/includes/partials/header.php">-->
    <link rel="stylesheet" href="/projekt/includes/css/custom.css">
    <title>WELCOME</title>
</head>
<body>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="d-flex justify-content-center text-bg-primary">
                        <div class="col-12 col-xl-9">
                            ...
                            <p class="lead mb-5">Create your account now and access our premium services.</p>
                            <div class="text-endx">
                    ...
                    <div class="card border-0 rounded-4">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-4">
                                        <h2 class="h3" style="color: grey">Registration</h2>
                                        <h3 class="fs-6 fw-normal text-secondary m-0">Enter your details to
                                            register</h3>
                                    </div>
                                </div>
                            </div>
                            <form class="m-t" role="form" action="login.php" onsubmit="return checkPass()">
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <span id = "email_message" class="float-start text-danger"></span>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="password"
                                                   ...
                                                   required
                                                   oninput="checkPass()">
                                            <span id = "password_message" class="float-start text-danger"></span>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="password"
                                                   ...
                                                   required
                                                   oninput="checkPass()">
                                            <span id = "confirm_password_message" class="float-start text-danger"></span>
...
<script>
    //kontolloj a eshte i njejte teksti tek confirm pass
    function checkPass() {
...
// validimi i emrit
        if (!alpha_regex.test(firstName)) {
            ...
            $("#name_message").text("Please enter a valid name (minimum 3 letters).");
            error++;
        } else {
...
// validimi i mbiemrit
        if (!alpha_regex.test(lastName)) {
            $("#lastName").addClass("border-danger");
            $("#surname_message").text("Please enter a valid last name (minimum 3 letters).");
            error++;
        } else {
